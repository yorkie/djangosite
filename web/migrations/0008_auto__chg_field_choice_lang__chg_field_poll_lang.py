...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'web_choice', 'lang', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Poll.lang'
        db.alter_column(u'web_poll', 'lang', self.gf('django.db.models.fields.IntegerField')())
